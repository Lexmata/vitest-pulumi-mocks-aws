...
export function Listener(ctx: MockCtx): Record<string, any> {
  ...
  out.defaultActions = (i.defaultActions !== undefined ? i.defaultActions : (depth > 4 ? [] : [(depth > 4 ? {} : T_lb.lb_ListenerDefaultAction(ctx, depth + 1))]));
  out.loadBalancerArn = (i.loadBalancerArn !== undefined ? i.loadBalancerArn : h.arn(ctx));
  out.mutualAuthentication = (i.mutualAuthentication !== undefined ? i.mutualAuthentication : (depth > 4 ? {} : T_lb.lb_ListenerMutualAuthentication(ctx, depth + 1)));
...
export function ListenerRule(ctx: MockCtx): Record<string, any> {
  ...
  const i: Record<string, any> = (ctx.inputs ?? {}) as any;
  const out: Record<string, any> = {};
  out.actions = (i.actions !== undefined ? i.actions : (depth > 4 ? [] : [(depth > 4 ? {} : T_lb.lb_ListenerRuleAction(ctx, depth + 1))]));
  out.arn = h.arn(ctx);
  out.conditions = (i.conditions !== undefined ? i.conditions : (depth > 4 ? [] : [(depth > 4 ? {} : T_lb.lb_ListenerRuleCondition(ctx, depth + 1))]));
  out.listenerArn = (i.listenerArn !== undefined ? i.listenerArn : h.arn(ctx));
...
export function LoadBalancer(ctx: MockCtx): Record<string, any> {
  ...
  const i: Record<string, any> = (ctx.inputs ?? {}) as any;
  const out: Record<string, any> = {};
  out.accessLogs = (i.accessLogs !== undefined ? i.accessLogs : (depth > 4 ? {} : T_lb.lb_LoadBalancerAccessLogs(ctx, depth + 1)));
  out.arn = h.arn(ctx);
  out.arnSuffix = "";
  out.clientKeepAlive = (i.clientKeepAlive !== undefined ? i.clientKeepAlive : 0);
  out.connectionLogs = (i.connectionLogs !== undefined ? i.connectionLogs : (depth > 4 ? {} : T_lb.lb_LoadBalancerConnectionLogs(ctx, depth + 1)));
  ...
  out.ipamPools = (i.ipamPools !== undefined ? i.ipamPools : (depth > 4 ? {} : T_lb.lb_LoadBalancerIpamPools(ctx, depth + 1)));
  out.loadBalancerType = (i.loadBalancerType !== undefined ? i.loadBalancerType : "");
  out.minimumLoadBalancerCapacity = (i.minimumLoadBalancerCapacity !== undefined ? i.minimumLoadBalancerCapacity : (depth > 4 ? {} : T_lb.lb_LoadBalancerMinimumLoadBalancerCapacity(ctx, depth + 1)));
  ...
  out.subnetMappings = (i.subnetMappings !== undefined ? i.subnetMappings : (depth > 4 ? [] : [(depth > 4 ? {} : T_lb.lb_LoadBalancerSubnetMapping(ctx, depth + 1))]));
...
export function TargetGroup(ctx: MockCtx): Record<string, any> {
  ...
  out.healthCheck = (i.healthCheck !== undefined ? i.healthCheck : (depth > 4 ? {} : T_lb.lb_TargetGroupHealthCheck(ctx, depth + 1)));
  out.ipAddressType = (i.ipAddressType !== undefined ? i.ipAddressType : "");
  ...
  out.stickiness = (i.stickiness !== undefined ? i.stickiness : (depth > 4 ? {} : T_lb.lb_TargetGroupStickiness(ctx, depth + 1)));
  out.tags = (i.tags !== undefined ? i.tags : {});
  out.tagsAll = { ...(i.tags ?? {}) };
  out.targetFailovers = (i.targetFailovers !== undefined ? i.targetFailovers : (depth > 4 ? [] : [(depth > 4 ? {} : T_lb.lb_TargetGroupTargetFailover(ctx, depth + 1))]));
  out.targetGroupHealth = (i.targetGroupHealth !== undefined ? i.targetGroupHealth : (depth > 4 ? {} : T_lb.lb_TargetGroupTargetGroupHealth(ctx, depth + 1)));
  out.targetHealthStates = (i.targetHealthStates !== undefined ? i.targetHealthStates : (depth > 4 ? [] : [(depth > 4 ? {} : T_lb.lb_TargetGroupTargetHealthState(ctx, depth + 1))]));
...
export function TrustStore(ctx: MockCtx): Record<string, any> {
  const depth = 0;
  const i: Record<string, any> = (ctx.inputs ?? {}) as any;
  const out: Record<string, any> = {};
  out.arn = h.arn(ctx);
  out.arnSuffix = "";
  out.caCertificatesBundleS3Bucket = (i.caCertificatesBundleS3Bucket !== undefined ? i.caCertificatesBundleS3Bucket : "");
  out.caCertificatesBundleS3Key = (i.caCertificatesBundleS3Key !== undefined ? i.caCertificatesBundleS3Key : "");
  out.caCertificatesBundleS3ObjectVersion = (i.caCertificatesBundleS3ObjectVersion !== undefined ? i.caCertificatesBundleS3ObjectVersion : "");
  out.name = (i.name !== undefined ? i.name : ctx.name);
  out.namePrefix = (i.namePrefix !== undefined ? i.namePrefix : "");
  out.tags = (i.tags !== undefined ? i.tags : {});
  out.tagsAll = { ...(i.tags ?? {}) };
...
export function TrustStoreRevocation(ctx: MockCtx): Record<string, any> {
  const depth = 0;
  const i: Record<string, any> = (ctx.inputs ?? {}) as any;
  const out: Record<string, any> = {};
  out.revocationId = 0;
  out.revocationsS3Bucket = (i.revocationsS3Bucket !== undefined ? i.revocationsS3Bucket : "");
  out.revocationsS3Key = (i.revocationsS3Key !== undefined ? i.revocationsS3Key : "");
  out.revocationsS3ObjectVersion = (i.revocationsS3ObjectVersion !== undefined ? i.revocationsS3ObjectVersion : "");
  out.trustStoreArn = (i.trustStoreArn !== undefined ? i.trustStoreArn : h.arn(ctx));
  return out;
}
